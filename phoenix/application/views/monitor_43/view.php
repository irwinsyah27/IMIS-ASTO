	...
	<div class="col-xs-12"> 
		...
		<div class="table-header">
			...
			<?php if  (_USER_ACCESS_LEVEL_ADD == "1") { ?>
				...
				<button onclick="goToReport()" class="btn btn-white btn-info btn-bold pull-right">
			...
			<a href="http://10.13.130.50/phoenix/contoh_template_travel_time_43.xls" class="btn btn-white btn-info btn-bold pull-right" >
		...
		<div>
			<form action="<?php echo base_url('monitor_43/truncate');?>" method="post" name="frmData" id="frmData">
...
<div id="modal-import-data" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<form class="form-horizontal" method="POST" id="frmImportData" enctype="multipart/form-data" action="<?php echo base_url('monitor_43/import_action');?>">
			<div class="modal-header no-padding">
				<div class="table-header " id="title_materi_paket_sesi">
					Import data time monitor 43
				</div>
			</div>
...
<div id="modal-eksport-data" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<form class="form-horizontal" method="POST" id="frmEksportData" enctype="multipart/form-data" action="<?php echo base_url('monitor_43/eksport_action');?>">
			<div class="modal-header no-padding">
				<div class="table-header " id="title_materi_paket_sesi">
					Eksport data time monitor 43
				</div>
			</div>
