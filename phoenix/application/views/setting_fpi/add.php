								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="row">
											<div> 
												<form action="<?php echo base_url('setting_fpi/add_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
											 		<div class="form-group">
				 										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Factor</label> 
														  
														<div class=" col-sm-2">
															<div class=" input-group ">
				 											<input class="form-control" name="factor" id="factor" type="text" style="background-color: #e5f62a"/>
															</div>
														</div> 
													</div>   
													<div class="form-group">
														...
														<div class=" col-sm-2">
															<div class=" input-group ">
				 											<input class="form-control" name="batas_hm_bawah" id="batas_hm_bawah" type="text" style="background-color: #e5f62a"/>
															</div>
														</div> 
													</div>  
													<div class="form-group">
														...
														<div class=" col-sm-2">
															<div class=" input-group ">
				 											<input class="form-control" name="batas_hm_atas" id="batas_hm_atas" type="text" style="background-color: #e5f62a"/>
															</div>
														</div> 
													</div>   
