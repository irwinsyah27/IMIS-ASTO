								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="table-header">
											...
											<a class="btn btn-white btn-info btn-bold pull-right" href="<?php echo base_url('master_posisi/view');?>">
										...
										<div class="row">
											<div > 
												<form action="<?php echo base_url('master_posisi/edit_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
													...
													<div class="clearfix form-actions">
														<div class="col-md-offset-3 col-md-9">
															...
															<input type="hidden" id="old_id" name="old_id" value="<?php echo $rs["master_posisi_id"];?>">
