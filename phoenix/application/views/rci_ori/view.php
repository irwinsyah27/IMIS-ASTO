	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="table-header">
				...
				<a class="btn btn-white btn-info btn-bold pull-right" href="<?php echo base_url('rci/add');?>">
			...
			<div>
				<form action="<?php echo base_url('rci/truncate');?>" method="post" name="frmData" id="frmData">
