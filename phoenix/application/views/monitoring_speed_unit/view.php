...
<div ng-app="app" ng-controller="MonitoringSpeedUnitCtrl">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="input-group col-sm-3">
				...
				<input type="text" ng-model="fdate" class="form-control search-query  date-picker" data-date-format="yyyy-mm-dd"  placeholder="select date..." dtpick/>
