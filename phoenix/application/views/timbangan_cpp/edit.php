								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="row">
											<div> 
												<form action="<?php echo base_url('timbangan_cpp/edit_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
														<input  name="bruto" id="bruto" class="col-xs-10 col-sm-2" style="background-color: #e5f62a" type="text" placeholder="bruto" value="<?php echo $rs["bruto"];?>">
														</div>
													</div>  
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tara </label>
														<div class="col-sm-9">
														<input  name="tara" id="tara" class="col-xs-10 col-sm-2" style="background-color: #e5f62a" type="text" placeholder="tara" value="<?php echo $rs["tara"];?>">
														</div>
													</div>  
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class=" col-sm-2">
															<div class=" input-group ">
				 											<input class="form-control date-picker" name="date_weigher" style="background-color: #e5f62a" id="date_weigher" type="text" data-date-format="yyyy-mm-dd"  value="<?php echo $rs["date_weigher"];?>" />
													...
													<div class="form-group">
														...
														<div class=" col-sm-2">
															<div class=" input-group ">
				 											<input class="form-control  bootstrap-timepicker" style="background-color: #e5f62a" name="time_weigher" id="time_weigher" type="text" data-date-format="HH:mm"   value="<?php echo $rs["time_weigher"];?>"  />
															<span class="input-group-addon">
