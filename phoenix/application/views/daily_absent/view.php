								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											...
											<a class="btn btn-white btn-info btn-bold pull-right" href="<?php echo base_url('daily_absent/add');?>">
										...
										<div>
											<form action="<?php echo base_url('daily_absent/truncate');?>" method="post" name="frmData" id="frmData">
								...
								<div id="modal-eksport-data-untuk-absensi" class="modal fade" tabindex="-1">
			                        <div class="modal-dialog">
			                            <div class="modal-content">
			                                <form class="form-horizontal" method="POST" id="frmEksportDataUntukAbsensi" enctype="multipart/form-data" action="<?php echo base_url('daily_absent/eksport_action_untuk_absensi');?>">
			                                <div class="modal-header no-padding">
			                                    <div class="table-header " id="title_materi_paket_sesi">
			                                        Eksport data Absensi bentuk txt
			                                    </div>
			                                </div>

			                                <div class="modal-body" style="min-height:100px; margin:10px">
			                                	<div class="form-group">
				 									<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Terminal</label>
													<div class="col-sm-8">
														<div class="">
															 <select name="terminals_id" id="terminals_id">
																	<option value="">Seluruh Mesin</option>
															<?php
