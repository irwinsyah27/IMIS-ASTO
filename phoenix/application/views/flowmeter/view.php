<div class="row">
	<div class="col-xs-12">
		...
		<div class="table-header">
			...
			<a class="btn btn-white btn-info btn-bold pull-right" href="<?php echo base_url('flowmeter/add');?>">
		...
		<div>
			<form action="<?php echo base_url('flowmeter/truncate');?>" method="post" name="frmData" id="frmData">
				<table id="dynamic-table" class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th>Status</th>
							<th>Fuel Tank</th>
							<th>Flowmeter Awal</th>
							<th>Flowmeter Akhir</th>
							<th>Sounding Awal</th>
							<th>Sounding Akhir</th>
							<th>Volume By Flowmeter</th>
							<th>Volume By Sounding</th>
							<th>Selisih Volume</th>
							<th width="100px">
...
<div id="modal-import-data" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" id="frmImportData" enctype="multipart/form-data" action="<?php echo base_url('flowmeter/import_action');?>">
            <div class="modal-header no-padding">
...
<div id="modal-eksport-data" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" id="frmEksportData" enctype="multipart/form-data" action="<?php echo base_url('flowmeter/eksport_action');?>">
            <div class="modal-header no-padding">
                <div class="table-header " id="title_materi_paket_sesi">
                    Eksport data Flowmeter
                </div>
            </div>
