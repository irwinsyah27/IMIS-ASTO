<div class="row">
	<div class="col-xs-12">
		...
		<div class="table-header">
			...
			<a class="btn btn-white btn-info btn-bold pull-right" href="<?php echo base_url('isi_bensin/view');?>">
		...
		<div class="row">
			<div>
				<form enctype="multipart/form-data" action="<?php echo base_url('isi_bensin/import_action');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
