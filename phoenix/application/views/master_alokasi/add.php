								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="row">
											<div> 
												<form action="<?php echo base_url('master_alokasi/add_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
											 		 
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Keterangan </label>
														<div class="col-sm-9">
														<input name="alokasi" id="alokasi" class="col-xs-10 col-sm-5" type="text" placeholder="">
														</div>
													</div>   
													<div class="form-group">
