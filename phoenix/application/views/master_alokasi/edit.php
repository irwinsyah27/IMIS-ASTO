								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="table-header">
											...
											<a class="btn btn-white btn-info btn-bold pull-right" href="<?php echo base_url('master_alokasi/view');?>">
										...
										<div class="row">
											<div > 
												<form action="<?php echo base_url('master_alokasi/edit_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
											 		 
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Keterangan </label>
														<div class="col-sm-9">
														<input name="alokasi" id="alokasi" class="col-xs-10 col-sm-5" type="text" value="<?php echo $rs["alokasi"];?>">
														</div>
													</div>    
													<div class="form-group">
													...
													<div class="clearfix form-actions">
														<div class="col-md-offset-3 col-md-9">
															...
															<input type="hidden" id="old_id" name="old_id" value="<?php echo $rs["master_alokasi_id"];?>">
