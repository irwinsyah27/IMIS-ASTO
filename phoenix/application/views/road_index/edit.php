<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="row">
											<div > 
											<form action="<?php echo base_url('road_index/edit_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
				 										...
				 										<div class="col-sm-9">
				 											...
				 											<select name="nip" id="nip" class="chosen-select" style="width: 300px;">
																...
																FOREACH ($list_operator AS $l) {
																	$selected  = "";
																	if ($l["nrp"] == $rs["nip"]) $selected = " selected";
																?>
											...
											<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Shift </label> 
				 										<div class="col-sm-9">
				 											...
				 											<select name="master_shift_id" id="master_shift_id" class="chosen-select" style="width: 200px;">
																<?php
																FOREACH ($list_shift AS $lsh) {
																	$selected  = "";
																	if ($lsh["master_shift_id"] == $rs["master_shift_id"]) $selected = " selected";
																?>
																<option value="<?php echo $lsh["master_shift_id"];?>" <?php echo $selected;?>><?php echo $lsh["keterangan"];?></option>
																<?php
																}
																?> 
															 </select> 
												...
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Date Time Awal Temuan</label>
													<div class="col-sm-2">
														<div class=" input-group ">
															<?php $this->mylib->inputdate("date_awal",date("Y-m-d"),$rs["date_awal"]);?>
											...
											<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Date Selesai Maintenance</label>
														<div class="col-sm-2">
															<div class=" input-group ">
														 		<?php $this->mylib->inputdate("date_akhir",date("Y-m-d"));?>
															 	<span class="input-group-addon">
																	<i class="fa fa-calendar bigger-110"></i>
																</span>
															</div>
											...
											<div class="form-group <?= form_error('file') ? 'has-error' : '' ?>">
														<label for="" class="control-label col-md-3">Upload Foto Akhir</label>
														<div class="col-md-5">
															<input type="file" name="file2" class="form-control" style="width: 300px;" >
				 										...
				 										<div class="col-sm-9">
				 											...
				 											<select name="sta_lokasi_id" id="sta_lokasi_id" class="chosen-select" style="width: 100px;">
																...
																FOREACH ($list_sta_lokasi AS $lsl) {
																	$selected  = "";
																	if ($lsl["sta_lokasi_id"] == $rs["sta_lokasi_id"]) $selected = " selected";

																?>
																<option value="<?php echo $lsl["sta_lokasi_id"];?>" <?php echo $selected;?>><?php echo $lsl["sta_lokasi"];?></option>
																<?php
																}
																?> 
															 </select> 
				 											...
				 											<select name="master_sta_meter_id" id="master_sta_meter_id" class="chosen-select" style="width: 100px;">
																...
																FOREACH ($list_sta_meter AS $lsm) {
																	$selected  = "";
																	if ($lsm["master_sta_meter_id"] == $rs["master_sta_meter_id"]) $selected = " selected";
																?>
																<option value="<?php echo $lsm["master_sta_meter_id"];?>" <?php echo $selected;?>><?php echo $lsm["sta_meter"];?></option>
																<?php
																}
																?> 
															 </select> 
				 										...
				 										<div class="col-sm-9">
				 											...
				 											<select name="master_kerusakan_id" id="master_kerusakan_id" class="chosen-select" style="width: 300px;">
																...
																FOREACH ($list_problem_road AS $lr) {
																	$selected  = "";
																	if ($lr["master_kerusakan_id"] == $rs["master_kerusakan_id"]) $selected = " selected";
																?>
																<option value="<?php echo $lr["master_kerusakan_id"];?>" <?php echo $selected;?>><?php echo $lr["kerusakan"];?></option>
																<?php
																}
																?> 
															 </select> 
				 										...
				 										<div class="col-sm-9">
				 											...
				 											<select name="master_severity_id" id="master_severity_id" class="chosen-select" style="width: 300px;">
																...
																FOREACH ($list_severity AS $lt) {
																	$selected  = "";
																	if ($lt["master_severity_id"] == $rs["master_severity_id"]) $selected = " selected";
																?>
																<option value="<?php echo $lt["master_severity_id"];?>" <?php echo $selected;?>><?php echo $lt["severity"];?></option>
																<?php
																}
																?> 
															 </select> 
