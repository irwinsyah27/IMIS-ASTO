										...
										<div class="table-header">
											...
											<a class="btn btn-white btn-info btn-bold pull-right" href="<?php echo base_url('road_index/add');?>">
										...
										<div>
											<form action="<?php echo base_url('road_index/truncate');?>" method="post" name="frmData" id="frmData">
												<table id="dynamic-table" class="table table-striped table-bordered table-hover">
													<thead>
														<tr>
															...
															<th>NRP</th>
															<th>Nama</th>
															<th>Date Time Awal Temuan</th>
															<th>Foto Awal</th>
															<th>Date Time Selesai Perbaikan</th>
															<th>Foto Akhir</th>
                                                            <th>Shift</th>
															<th>STA Lokasi</th>
															<th>STA Meter</th>
								...
								<div id="modal-import-data" class="modal fade" tabindex="-1">
			                        <div class="modal-dialog">
			                            <div class="modal-content">
			                                <form class="form-horizontal" method="POST" id="frmImportData" enctype="multipart/form-data" action="<?php echo base_url('road_index/import_action');?>">
			                                <div class="modal-header no-padding">
								...
								<div id="modal-eksport-data" class="modal fade" tabindex="-1">
			                        <div class="modal-dialog">
			                            <div class="modal-content">
			                                <form class="form-horizontal" method="POST" id="frmEksportData" enctype="multipart/form-data" action="<?php echo base_url('road_index/eksport_action');?>">
			                                <div class="modal-header no-padding">
			                                    <div class="table-header " id="title_materi_paket_sesi">
			                                        Eksport Data Road Index
			                                    </div>
			                                </div>
