								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="row">
											<div> 
												<form action="<?php echo base_url('master_breakdown/add_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
														<input name="ket_en" id="ket_en" class="col-xs-10 col-sm-5" type="text" placeholder="">
														</div>
													</div>   
													<div class="form-group">
