								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="table-header">
											...
											<a class="btn btn-white btn-info btn-bold pull-right" href="<?php echo base_url('master_breakdown/add');?>">
										...
										<div>
											<form action="<?php echo base_url('master_breakdown/truncate');?>" method="post" name="frmData" id="frmData">
								...
								<div id="modal-import-data" class="modal fade" tabindex="-1">
			                        <div class="modal-dialog">
			                            <div class="modal-content">
			                                <form class="form-horizontal" method="POST" id="frmImportData" enctype="multipart/form-data" action="<?php echo base_url('master_breakdown/import_action');?>">
			                                <div class="modal-header no-padding">
			                                    <div class="table-header " id="title_materi_paket_sesi">
			                                        Import data Master breakdown
			                                    </div>
			                                </div>
								...
								<div id="modal-eksport-data" class="modal fade" tabindex="-1">
			                        <div class="modal-dialog">
			                            <div class="modal-content">
			                                <form class="form-horizontal" method="POST" id="frmEksportData" enctype="multipart/form-data" action="<?php echo base_url('master_breakdown/eksport_action');?>">
			                                <div class="modal-header no-padding">
			                                    <div class="table-header " id="title_materi_paket_sesi">
			                                        Eksport Data Master breakdown
			                                    </div>
			                                </div>
