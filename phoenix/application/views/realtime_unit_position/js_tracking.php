    ...
    */
    ...
    function getAllRoutesForMap() {
       ...
       // routeSelect.selectedIndex = 0;
        ...
        $.ajax({
            url: '<?php echo _URL."realtime_unit_position/tracking";?>',
            type: 'GET',
            dataType: 'json',
    ...
    function getRouteForMap() {  
        if (hasMap()) {
           ...
           var url = '<?php echo _URL;?>'+'realtime_unit_position/tracking/' + $('#kendaraan').val()+'/' + $('#start_date').val()+'/' + $('#start_time').val()+'/' + $('#end_date').val()+'/' + $('#end_time').val();
