								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="row">
											<div> 
												<form action="<?php echo base_url('setting_dailycheck/add_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
											 		<div class="form-group">
														...
														<div class=" col-sm-2">
															<select name="day" id="day" class="chosen-select" style="width: 200px;">
																...
																FOR ($i=1;$i<=7;$i++) {
																?>
																<option value="<?php echo $i;?>"><?php echo $hari[$i];?></option>
																<?php
																}
																?> 
															 </select> 
