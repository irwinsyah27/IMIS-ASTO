...
class Timbangan_port extends CI_Controller {
 	private $folder_name			= "timbangan_port";
 	private $table_name 			= "weigher";
 	private $primary_key 			= "weigher_id";
 	private $label_modul			= "Timbangan Port";
 	private $model_name				= "timbangan_port_model";
 	...
 	private $label_gagal_ditambah 	= "Data gagal ditambah";
   	...
   	public function __construct() {
		...
		$this->data['breadcrumb'] = '<li>
							...
							<li class="active">Timbangan Port</li>';

      	$this->data["folder_name"]	= $this->folder_name;
		$this->load->model( $this->model_name );

		$menu["parent_menu"] 		= "";
		$menu["sub_menu"] 			= "timbangan_port"; 
		$this->data['check_menu']	= $menu;
 
		$this->load->model('master_equipment_model');

		# akses level
		$akses 			= $this->timbangan_port_model->user_akses("timbangan_port");
	...
	{					
		$this->data['title'] 		= "List Data Timbangan Port"; 
		$this->data['js'] 			= 'timbangan_port/js_view';
		$this->data['sview'] 		= 'timbangan_port/view'; 
		$this->load->view(_TEMPLATE , $this->data);
	}

	public function get_data(){
		$this->timbangan_port_model->get_list_data();
	}
	...
	{					
		$this->data['list_unit'] 		= $this->master_equipment_model->getAllData();
		$this->data['list_material']	= $this->mylib->generate2darray("material" , "material_id","material"); 
		$this->data['rs'] 				= $this->timbangan_port_model->getRowData($id);

		$this->data['title'] 		= "Edit Data Timbangan Port"; 
		$this->data['js'] 			= 'timbangan_port/js_edit';
		$this->data['sview'] 		= 'timbangan_port/edit'; 
		$this->load->view(_TEMPLATE , $this->data);
	}
	...
	{	 
		...
		$data 			= $this->timbangan_port_model->getTimbanganPort($this->input->post("start"),$this->input->post("end"));
