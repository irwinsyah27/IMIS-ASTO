...
class MofonApi extends CI_Controller
{
    ...
    public function upload()
    {
        ...
        foreach($rows as $r)
        {
            ...
            $data = [   
                ...
                'tidur_ke_1'            => $r->tidur_ke_1,
                'bangun_ke_1'           => $r->bangun_ke_1,
                'tidur_ke_2'            => $r->tidur_ke_2,
                'bangun_ke_2'           => $r->bangun_ke_2,
                'jam_tidur_kemarin'     => $r->jam_tidur_kemarin,
    ...
    public function getVersion()
    {
        $this->return(
			$this->db
				->select('id, nama_aplikasi, versi')
				->get('app_version')->result()
		);
    }

    public function getOperator($nrp)
    {
