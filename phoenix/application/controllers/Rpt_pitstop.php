...
class Rpt_pitstop extends CI_Controller {
   	...
   	public function __construct() {
		...
		$menu["sub_menu"] 			= "rpt_pitstop"; 
		$this->data['check_menu']	= $menu;

		# akses level
		$akses 			= $this->report_entry_data_model->user_akses("rpt_pitstop");
	...
	{					 
		$this->data['title'] 		= "Report Data Pitstop"; 
		$this->data['js'] 			= 'rpt_pitstop/js_view';
		$this->data['sview'] 		= 'rpt_pitstop/view'; 
	...
	*/
	...
	{ 
		...
		$data 			= $this->report_entry_data_model->getPitstop($start,$end);
	  
		$colnames 			= array("UNIT","SHIFT", "PITSTOP","TGL MASUK","TGL KELUAR","KETERANGAN");
		$colfields 			= array("new_eq_num","shift", "station_name","date_time_in","date_time_out","description");
