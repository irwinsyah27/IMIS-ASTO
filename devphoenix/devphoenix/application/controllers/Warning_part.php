...
class Warning_part extends CI_Controller {
   	...
   	public function __construct() {
		...
		$this->data['breadcrumb'] = '<li>
							...
							<li class="active">Warning Part</li>';
		...
		$menu["sub_menu"] 			= "warning_part"; 
		$this->data['check_menu']	= $menu;

		# akses level
		$akses 			= $this->leadtime_breakdown_model->user_akses("warning_part");
	...
	{					 		 
		...
		$this->data['rs'] 		= $this->leadtime_breakdown_model->getAllDataWarningPart();
		$this->data['title'] 		= "Warning Part"; 
		$this->data['js'] 			= 'warning_part/js_view';
		$this->data['sview'] 		= 'warning_part/view'; 
		$this->load->view(_TEMPLATE , $this->data);
	} 
	public function get_data_warning_part()
	{					 
		if (empty($_POST["type"])) $_POST["type"] = "";
		if (empty($_POST["breakdown"])) $_POST["breakdown"] = "";
		$rs 		= $this->leadtime_breakdown_model->getAllDataWarningPart($_POST["type"],  $_POST["breakdown"]); 
