...
class Realtime_payload_cpp extends CI_Controller {
   	...
   	public function __construct() {
		...
		$this->data['breadcrumb'] = '<li>
							...
							<li class="active">Realtime Payload CPP</li>';

		//$this->load->model('proto_model');
		$this->load->model("realtime_payload_cpp_model");  

		$menu["parent_menu"] 		= "dashboard";
		$menu["sub_menu"] 			= "realtime_payload_cpp"; 
		$this->data['check_menu']	= $menu;

		# akses level
		$akses 			= $this->realtime_payload_cpp_model->user_akses("realtime_payload_cpp");
	...
	{					    
		...
		$rs 		= $this->realtime_payload_cpp_model->getAllDataPerDayFromTimbangan($tgl, $shift); 
	...
	{					  
		$this->data['title'] 		= "Realtime Payload CPP"; 
		$this->data['js'] 			= 'realtime_payload_cpp/js_view_timbangan';
		$this->data['sview'] 		= 'realtime_payload_cpp/view_timbangan'; 
	...
	{					 
		$id 		= $_GET['id']; 
		$shift 		= $_GET['shift']; 
		$rs 		= $this->realtime_payload_cpp_model->getAllDataPerDayFromTimbangan($id, $shift); 
	...
	{					  
		$this->data['title'] 		= "Realtime Payload_cpp"; 
		$this->data['js'] 			= 'realtime_payload_cpp/js_view';
		$this->data['sview'] 		= 'realtime_payload_cpp/view'; 
		$this->load->view(_TEMPLATE , $this->data);
	} 
	public function get_data()
	{					 
		$id 		= $_GET['id']; 
		$rs 		= $this->realtime_payload_cpp_model->getAllDataPerDay($id); 
		...
		if (count($rs)>0) {
			FOREACH ($rs AS $l) { 
				...
				$tonnage_data = $this->realtime_payload_cpp_model->getTonnageDataPerDay($l["master_equipment_id"], $l["tgl_payload"], $l["shift"]); 
