<?php
class timbangan_port_model extends MY_Model{	  
	...
	public function get_list_data(){
		...
		/* Filtering */
		$sWhere = " WHERE 1 = 1 AND station_id = 2 ";
		...
		, e.keterangan as egi, d.kode as owner
		FROM $sTable
		$sWhere
		$sOrder
		$sLimit
		...
		foreach($rResult as $row){ 
			...
			*/
			...
			if (_USER_ACCESS_LEVEL_UPDATE == "1")  {
				$edit = '<a class="green" href="'.base_url('timbangan_port/edit/' . $row->weigher_id).'"><i class="ace-icon fa fa-pencil bigger-130"></i></a>';
				$edit_1 = '<li><a href="'.base_url('timbangan_port/edit/' . $row->weigher_id).'" class="tooltip-success" data-rel="tooltip" title="Edit"><span class="green"><i class="ace-icon fa fa-pencil-square-o bigger-120"></i></span></a></li>';
			}
			$delete = "";
			$delete_1 = "";
			if (_USER_ACCESS_LEVEL_DELETE == "1")  {
				$delete = '<a class="red" href="'.base_url('timbangan_port/delete/' . $row->weigher_id).'"  role="button"  data-toggle="modal" data-confirm="Apakah anda yakin ingin menghapus data '.$row->new_eq_num.'?"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>';
				$delete_1 = '<li><a href="'.base_url('timbangan_port/delete/' . $row->weigher_id).'" class="tooltip-error" data-rel="tooltip" title="Delete" data-toggle="modal" data-confirm="Apakah anda yakin ingin menghapus data '.$row->new_eq_num.'?"><span class="red"><i class="ace-icon fa fa-trash-o bigger-120"></i></span></a></li>';
			}
	...
	public function getTimbanganPort($start = "", $end="") {  
		$sql = "SELECT
					...
					d.kode as owner, c.alokasi,a.date_weigher,a.shift,a.time_weigher,a.bruto,
