...
jQuery(function($) {
    ...
    $( "#btnDownload" ).click(function() {
        window.open("<?php echo site_url('realtime_payload/download/')?>/" + $("#txtFilterTotalProduksi").val()+"/"+ $("#shift").val(), '_blank'); 
    });
    ...
    function get_operator_ranking () {
        ...
        $.getJSON("<?php echo site_url('realtime_payload/get_data_timbangan');?>", {id: id, shift:shift} ,function(responseData) {
