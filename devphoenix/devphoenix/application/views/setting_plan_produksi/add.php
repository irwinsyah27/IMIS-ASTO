								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="row">
											<div> 
												<form action="<?php echo base_url('setting_plan_produksi/add_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
													...
													<div class="form-group">
														...
														<div class=" col-sm-2">
															<div class=" input-group ">
				 											<input class="form-control" name="produksi" id="produksi" type="text" style="background-color: #e5f62a"/>
															</div>
														</div> 
													</div>  
