								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="row">
											<div > 
												<form action="<?php echo base_url('master_material/edit_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
											 		<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kode </label>
														<div class="col-sm-2">
														<input name="material_id" id="material_id" class="col-xs-10 col-sm-5" type="text" value="<?php echo $rs["material_id"];?>">
														</div>
													</div> 
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Material </label>
														<div class="col-sm-9">
														<input name="material" id="material" class="col-xs-10 col-sm-5" type="text" value="<?php echo $rs["material"];?>">
														</div>
													</div>    
													<div class="form-group">
													...
													<div class="clearfix form-actions">
														<div class="col-md-offset-3 col-md-9">
															...
															<input type="hidden" id="old_id" name="old_id" value="<?php echo $rs["id"];?>">
