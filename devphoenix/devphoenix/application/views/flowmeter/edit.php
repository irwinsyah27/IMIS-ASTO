			...
			<div>
				<form method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
						...
						<div class=" col-sm-2">
							<div class=" input-group ">
								<select class="form-control" name="status" id="status">
									...
									<option value="<?= $k ?>" <?= $rs->status == $k ? 'selected' : '' ?>><?= $v ?></option>
									<?php endforeach ?>
								</select>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class=" col-sm-2">
							<div class=" input-group ">
								<input class="form-control" name="flowmeter_awal" id="flowmeter_awal" type="number" style="background-color: #e5f62a" value="<?php echo $rs->flowmeter_awal;?>"  />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class=" col-sm-2">
							<div class=" input-group ">
								<input class="form-control" name="flowmeter_akhir" id="flowmeter_akhir" type="number" style="background-color: #e5f62a" value="<?php echo $rs->flowmeter_akhir;?>" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class=" col-sm-2">
							<div class=" input-group ">
								<input class="form-control" name="sounding_awal" id="sounding_awal" type="number" style="background-color: #e5f62a" value="<?php echo $rs->sounding_awal;?>"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class=" col-sm-2">
							<div class=" input-group ">
								<input class="form-control" name="sounding_akhir" id="sounding_akhir" type="number" style="background-color: #e5f62a" value="<?php echo $rs->sounding_akhir;?>" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class=" col-sm-2">
							<div class=" input-group ">
								<input class="form-control" name="volume_by_sounding" id="volume_by_sounding" type="number" style="background-color: #e5f62a" value="<?php echo $rs->volume_by_sounding;?>" />
							</div>
						</div>
					</div>
