								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="row">
											<div > 
												<form action="<?php echo base_url('running_text/edit_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<select name="lokasi" id="lokasi" class="chosen-select">
					 												...
					 												<?php
					 												$selected_1 = ""; $selected_2 = ""; 
					 												if ($rs["lokasi"] == "leadtime_breakdown") $selected_1 = " selected";
					 												if ($rs["lokasi"] == "hourly_monitoring") $selected_2 = " selected";
					 												?>
													...
													<div class="clearfix form-actions">
														<div class="col-md-offset-3 col-md-9">
															...
															<input type="hidden" id="old_id" name="old_id" value="<?php echo $rs["running_text_id"];?>">
