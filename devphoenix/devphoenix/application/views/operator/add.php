								<div class="row">
									<div class="col-xs-12"> 
										...
										<div class="row">
											<div> 
												<form action="<?php echo base_url('operator/add_data');?>" method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
											 		<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> NRP </label>
														<div class="col-sm-9">
														<input id="form-field-1"  name="nrp" id="nrp" class="col-xs-10 col-sm-5" type="text" placeholder="">
														</div>
													</div> 
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
														<?php $this->mylib->selectbox("master_posisi_id","",$list_posisi," style=\"width: 200px;\"");?> 
														</div>
													</div>  
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Departemen </label>
														<div class="col-sm-9">
														<?php $this->mylib->selectbox("master_departemen_id","",$list_departemen," style=\"width: 200px;\"");?>  
														</div>
													</div>  
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Perusahaan </label>
														<div class="col-sm-9">
														<?php $this->mylib->selectbox("master_owner_id","",$list_perusahaan," style=\"width: 200px;\"");?>  
														</div>
													</div>  
													<div class="form-group">
